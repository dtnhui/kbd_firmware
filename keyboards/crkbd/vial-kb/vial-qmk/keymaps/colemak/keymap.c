...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
     GUI_CAPS,    KC_A,    KC_R,    KC_S,    KC_T,    KC_G,                         KC_M,    KC_N,    KC_E,    KC_I,    KC_O, KC_QUOT,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
  ...
  //,-----------------------------------------------------.                    ,-----------------------------------------------------.
       QWERTY,   KC_F1,   KC_F2,   KC_F3,   KC_F4, RGB_MOD,                      KC_SLSH,    KC_7,    KC_8,    KC_9, KC_MINS, COLEMAK,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
...
static void oled_render_layer_state(void) {
    ...
    oled_set_cursor(0, 0);
    if (_QWERTY == default_layer) {
        oled_write_raw(layer_layout[_QWERTY][led_state.caps_lock], sizeof(layer_inactive));
    } else if (_COLEMAK == default_layer) {
        oled_write_raw(layer_layout[_COLEMAK][led_state.caps_lock], sizeof(layer_inactive));
    } else {
    ...
    for (uint32_t i = 1; i < 4; i++) {
        ...
        if ((0 == i) && (0 == curr_layer)) {
            oled_write_raw(layer_pressed[0][led_state.caps_lock], sizeof(layer_inactive));
        } else if ((1 == i) && (TRI_LAYER_LOWER_LAYER == curr_layer)) {
            oled_write_raw(layer_pressed[1][led_state.caps_lock], sizeof(layer_inactive));
        } else if ((2 == i) && (TRI_LAYER_UPPER_LAYER == curr_layer)) {
            oled_write_raw(layer_pressed[2][led_state.caps_lock], sizeof(layer_inactive));
        } else if ((3 == i) && (TRI_LAYER_ADJUST_LAYER == curr_layer)) {
            oled_write_raw(layer_pressed[3][led_state.caps_lock], sizeof(layer_inactive));
        } else {
            oled_write_raw(layer_inactive, sizeof(layer_inactive));
        }
    }
